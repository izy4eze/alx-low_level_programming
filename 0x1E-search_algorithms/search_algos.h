 ...
 *
 * Description: singly linked node list structure
 ...
 * array of integer using the linear search algorithm
 */
...
/*
 * Function that searches for a value  in a sorted way
 * of integer using the Exponential search algorithm
 */

int exponential_search(int *array, size_t size, int value);

/* function that searches for a value in a sorted list
 * of integer the Jump search algorithm in a singly linked list
 */
